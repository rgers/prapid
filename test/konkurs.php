...
echo '
    ...
    Zestaw nagród na Luty 2010:<br />
    <img src="images/nagroda1.png"><img src="images/nagroda2.png"><img src="images/nagroda3.png"><br />
    <div style="font-size:18px; with:800px; margin-left:auto; margin-right:auto; text-align:left">Co miesiąc najaktywniejsi użytkownicy dostają od nas nagrody. W tym miesiącu do wygrania:<ul><li>zestaw bezprzewodowy mysz+klawiatura <b style="color:red">Logitech Wireless Desktop MK300</b> (miejsce 1.),</li>
...
if ($num>0) {
    echo "Wyniki (aktualizowane na bieżąco):<br />";
