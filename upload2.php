...
if ($s3->putObjectFile($uploadpath.$plik_nazwa, "cdn.gers.pl", $fid, S3::ACL_PUBLIC_READ)) {
    echo "<bt />Wysy�anie powiod�o si�.";
}else{
    echo "<br />Przykro nam, niestety wysy�anie nie powiod�o si�.";
}
unlink($uploadpath.$plik_nazwa);
...
echo "<tr><td>Link do ściągnięcia:</td><td><a href=http://".$domain."/download.php?plik=".$id.">http://".$domain."/".$id."/".$plik_nazwa."</a></td></tr>";
echo '</table>';
}
?> 
